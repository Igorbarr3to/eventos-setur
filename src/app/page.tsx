...
import FormMotoCross from "@/components/form-motocross";;

export default function Home() {
  return (
    <div className="bg-slate-100 min-h-screen w-full flex flex-col items-center justify-center">
      <h1 className="text-xl font-bold text-center mb-4 text-gray-800">Campeonato Estadual de Motocross Rondoniense 2025 - Pesquisa</h1>
